...
* Create thumbnails, previews and extract metadata
* Upload files to AWS S3, Azure, Google Cloud Platform and MinIO
* Relay to multiple FTP or consumer cloud services via zentransfer.io
...
Plus there's a ton of features I would like to see, and I guess you can come up with 
some too. Feel free to open issues here on GitHub!
...
You can support it by sharing and letting others know of ZenTransfer, using it,
providing feedback or opening issues here on GitHUb, by donating, or by subscribing 
to the zentransfer.io service. This way I can ensure there's coffee in my cup to 
keep me going through weekends and long, dark, winter nights here in Norway. Then 
more and better code will be coming your way!
